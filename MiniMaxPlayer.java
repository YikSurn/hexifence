...
public class MiniMaxPlayer implements Player, Piece {
	...
	public Move makeMove() {
        ...
        if (capturePoint != null) {
			...
			HashMap<Integer, Move> myBestMove = minimax(boardState, THRESHOLD, this.player);
	 ...
	 *  */
	private HashMap<Integer, Move> minimax(char[][] boardState, int depth, int maximizingPlayer) {
		...
		if (depth == 0 || moves.isEmpty()) {
			bestValue = evaluateBoardState(boardState, maximizingPlayer);
		}
		else {
	 ...
	 * */
	private int evaluateBoardState(char[][] boardState, int maximizingPlayer) {
		int numCapturedCells = 0;

		char playerCellIdentity = maximizingPlayer == RED ? Board.RED_CELL : Board.BLUE_CELL; 
	 ...
	 * */
	private char[][] generateChildBoardState(Move move, char[][] boardState, int maximizingPlayer) {
